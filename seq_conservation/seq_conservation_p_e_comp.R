# In this script I compare the sequence conservation of different categories of lincRNAs and protein-coding genes that are based
# on absence of presence of overlaps with promoters and /or enhancers. 
