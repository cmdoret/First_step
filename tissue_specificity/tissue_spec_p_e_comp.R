# This script intends to compare tissue specificity in expression (in RPKM) between 
# different categories of lincRNAs and protein-coding genes based on if they overlap
# promoter and/or enhancer marks
# Cyril Matthey-DOret
# 18.11.2016
