...
```{r correlation_chrom_linc, echo=F,fig.height=7}
...
```{r correlation_chrom_pc, echo=F,fig.height=7}
...
```{r correlation_TAD_linc, echo=F,fig.height=7}
...
```{r correlation_TAD_pc, echo=F,fig.height=7}
