...
TAD_b5 <- read.table("../data/TAD/TAD_boundaries5.bed")
TAD_b10 <- read.table("../data/TAD/TAD_boundaries10.bed")
TAD_b20 <- read.table("../data/TAD/TAD_boundaries20.bed")
whole_TAD <- read.table("../data/TAD/merged/")
```
