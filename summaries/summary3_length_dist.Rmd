...
Looking at the distribution of the overlap length betweeen RNAs and bins may give an insight into where genes are expressed in TADs. This is done by looking at all overlaps between TAD bins and RNAs without any minimum overlap requirement, and computing the median overlap length for each bin.