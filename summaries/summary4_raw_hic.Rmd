...
Since I already have a set of TADs, there is no need to compute the insulation score to find the TAD borders at local minima. I use directly the set of TADs to find the borders and slide from these coordinates until the point where the interactions decrease below a threshold.
