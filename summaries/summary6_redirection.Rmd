...
protein-coding|pro+bod|14846|34808|8486 (`r round((100*8486)/14846,1)`%)
   ...
   * __Testing enrichment at TAD boundaries__: The GAT framework was used to test if enhancer-bound lincRNA and protein-coding genes were enriched at TAD boundaries. For both gene types, it was done in two ways: testing enrichment of enhancer-bound and non-enhancer bound genes in the different bins, and testing enrichment of the different bins in enhancer-bound and non-enhancer bound genes.
