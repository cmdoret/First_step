# The purpose of this script is to compare the median expression level between the different categories of lincRNAs and 
# protein-coding genes I generated based on promoter and enhancer overlaps.
